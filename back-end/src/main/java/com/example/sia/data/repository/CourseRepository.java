...
public interface CourseRepository extends JpaRepository<Course, Long>, JpaSpecificationExecutor<Course> {
    ...
    @Query("SELECT course FROM Course course WHERE(course.major = ?1 AND course.status_delete = ?2)")
    List<Course> findAllCourseByMajor(Major major, boolean status_delete);
